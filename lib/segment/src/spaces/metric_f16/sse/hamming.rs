...
pub unsafe fn sse_hamming_similarity_half(
    ...
    unsafe { simple_sse::hamming_similarity_sse(&v1_f32, &v2_f32) }
}
...
mod tests {
    ...
    fn test_spaces_sse() {
        ...
        if is_x86_feature_detected!("sse") {
            ...
            let hamming_simd = unsafe { sse_hamming_similarity_half(&v1, &v2) };
