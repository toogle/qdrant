...
#[cfg(target_feature = "neon")]
unsafe extern "C" {
    fn hammingDist_half_4x4(v1: *const f16, v2: *const f16, n: i32) -> f32;
}

#[allow(clippy::missing_safety_doc)]
#[cfg(target_feature = "neon")]
pub unsafe fn neon_hamming_similarity_half(
    v1: &[VectorElementTypeHalf],
    v2: &[VectorElementTypeHalf],
) -> ScoreType {
    let n = v1.len();
    unsafe { -hammingDist_half_4x4(v1.as_ptr(), v2.as_ptr(), n.try_into().unwrap()) }
}
...
mod tests {
    ...
    fn test_spaces_neon() {
            ...
            && std::arch::is_aarch64_feature_detected!("fp16")
        {
            ...
            let hamming_simd = unsafe { neon_hamming_similarity_half(&v1, &v2) };
